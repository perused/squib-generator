...
def main():
    ...
    common_registry = {
        ""
        "face": SquibPart(os.path.join("resources", "squibs", "straight_squib", "face")),
        "arms": SquibPart(os.path.join("resources", "squibs", "straight_squib", "arms")),
        "legs": SquibPart(os.path.join("resources", "squibs", "straight_squib", "legs"))
